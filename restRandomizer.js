  ...
  var locality1 = document.getElementById('locality1');
  var locality2 = document.getElementById('locality2');
  var locality3 = document.getElementById('locality3');
  ...
  button.addEventListener('click', function(){
    ...
    $.ajax(cityQuery).done(function(response){
        ...
        $.ajax(restaurantsQuery).done(function(places){
          ...
          var rest1 = Math.floor((Math.random(emptyArray)*20)+1);
          var rest2 = Math.floor((Math.random(emptyArray)*20)+1);
          var rest3 = Math.floor((Math.random(emptyArray)*20)+1);

          if(rest1 === rest2 || rest1 === rest3 || rest2 == rest3){
            Math.floor((Math.random(emptyArray)*20)+1)
          } else{
          ...
          // if (places.restaurants[rest1].restaurant.name === ""|| places.restaurants[rest1].restaurant.name === null || places.restaurants[rest1].restaurant.name === undefined || places.restaurants[rest2].restaurant.name === "" || places.restaurants[rest2].restaurant.name === null || places.restaurants[rest2].restaurant.name === undefined || places.restaurants[rest3].restaurant.name === "" || places.restaurants[rest3].restaurant.name === null || places.restaurants[rest3].restaurant.name === undefined){
          //   Math.floor((Math.random(emptyArray)*20)+1);
          // } else{
          //
          // };
          ...
          cost1.innerHTML = "Average Cost for Two People:  \n" + places.restaurants[rest1].restaurant.currency + places.restaurants[rest1].restaurant.average_cost_for_two;
          cuisines1.innerHTML = "Cuisine Types: \n" + places.restaurants[rest1].restaurant.cuisines;
          userRat1.innerHTML = "User Rating: \n" + places.restaurants[rest1].restaurant.user_rating.aggregate_rating;
          locality1.innerHTML= "Neighborhood: " + places.restaurants[rest1].restaurant.location.locality;
          location1.innerHTML = "Address: \n" + places.restaurants[rest1].restaurant.location.address;
          ...
          locality2.innerHTML= "Neighborhood: " + places.restaurants[rest2].restaurant.location.locality;
          ...
          locality3.innerHTML= "Neighborhood: " + places.restaurants[rest3].restaurant.location.locality;
